...
export const STOP_STEMS: readonly string[] = [
  ...
  'цикл',
  'менстр',
  // Знайдено незалежним review Фази 2: механічний список з промпту пропускав
  // цілий пласт побутової медичної лексики, і згенерована фраза могла містити
  // «аневризма» або «астма» — у застосунку про неврологічні симптоми.
  'аневриз',
  'астма',
  'аспірин',
  'алерг',
